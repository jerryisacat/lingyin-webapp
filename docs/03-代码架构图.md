...
| GET/DELETE | `/api/user/images` | `api/user/images/route.ts` | `storage.ts`, `rate-limit.ts`, `validations.ts` | 图片列表 + 批量删除 |
| GET | `/api/user/images/stats` | `api/user/images/stats/route.ts` | `storage.ts`, `rate-limit.ts` | 图片统计（数量/总大小） |
